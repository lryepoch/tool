...
//        System.out.println(mapx);
        ...
        //com.base.map()中间操作，com.base.map()方法接收一个Functional接口
        //com.base.map()按照一定规则将原有对象转换成一个新的对象，但原对象不改变
//        accountsList = accountsList.stream().com.base.map(x->"哈哈哈:"+x).collect(Collectors.toList());
