...
public class FileDemo {
	...
	//	System.out.println(com.base.file.exists());
		
//		if(!com.base.file.exists())
		//创建的是一级目录，多级目录可以是file.mkdirs();
//			com.base.file.mkdirs();
//		else com.base.file.delete();
		
	//判断是不是一个目录
	//	System.out.println(com.base.file.isDirectory());
		
	//判断是不是一个文件
	//	System.out.println(com.base.file.isFile());
