...
public class ClassLoaderUtils {
     ...
     * 得到当前ClassLoader
     *
     * 为了避免在项目中加载不到本项目中静态资源文件的BUG发生，调用静态资源的classLoader最好用Thread.currentThread().getContextClassLoader()方法来获取，
     * 因为一般同一个项目中java代码和其静态资源文件都是同一个classLoader来加载的，以此确保通过此classLoader也能加载到本项目中的资源文件。
     *
     * @return ClassLoader
     */
